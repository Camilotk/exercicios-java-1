...
public class Teste {
    ...
    public static Veiculo[] buscaVeiculo(Veiculo[] veiculos, String placa) {
                ...
                switch (opcao) {
                    case 1:
                        if(counter[0] < veiculosPasseio.length) {
                            ...
                            Veiculo[] busca = buscaVeiculo(veiculosPasseio, carro.getPlaca());
                            if (busca.length > 0) {
                    ...
                    case 2:
                        ...
                        while(repetir.equals("sim")) {
                            if (counter[1] < veiculosPasseio.length) {
                                ...
                                Veiculo[] busca = buscaVeiculo(veiculosCarga, carga.getPlaca());
                                if (busca.length > 0) {
                    ...
                    case 5:
                        ...
                        Veiculo[] resultadoBuscaPasseio = buscaVeiculo(veiculosPasseio, buscaPasseio);
                        if(resultadoBuscaPasseio.length > 0) {
                            resultadoBuscaPasseio[0].imprimeDados();
                        } else {
                    ...
                    case 6:
                        ...
                        Veiculo[] resultadoBuscaCarga = buscaVeiculo(veiculosCarga, buscaCarga);
                        if(resultadoBuscaCarga.length > 0) {
                            resultadoBuscaCarga[0].imprimeDados();
                        } else {
                            System.out.println("Veiculo não encontrado");
                        }
                        break;
